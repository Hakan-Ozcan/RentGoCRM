...
namespace RntCar.CrmPlugins.VirtualBranch.Create
{
    public class PostCreateVirtualBranchInMongoDB : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                var response = virtualBranchBL.createVirtualBranchInMongoDB(postImg);
