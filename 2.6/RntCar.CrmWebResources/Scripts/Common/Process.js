...
Process.callAction = function (actionName, inputParams, successCallback, errorCallback, url, isAsync) {
    var ns = {
    ...
    Process._callActionBase(requestXml, successCallback, errorCallback, url, isAsync);
}
...
Process.callWorkflow = function (workflowId, recordId, successCallback, errorCallback, url, isAsync) {
    if (url == null) {
...
Process._callActionBase = function (requestXml, successCallback, errorCallback, url, isAsync) {
    if (typeof (isAsync) === "undefined") {
        isAsync = true
    }
    if (url == null) {
