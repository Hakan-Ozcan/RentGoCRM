...
*/
var userLang = Xrm.Page.context.getUserLcid()
var loadingText  = userLang == "1055" ? "Yükleniyor..." : "Loading...";
var Alert = Alert || {};

Alert._prefix = "rnt_"; // Change this if you have your own solution prefix (as long as the file structure's the same)
...
Alert.showLoading = function (url) {
    Alert.show(loadingText, null, [], "LOADING", 230, 115, url, true);
}
